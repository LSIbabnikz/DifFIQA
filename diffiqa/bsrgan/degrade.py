...
def auto_degrade(img):
    #img = util.imread_uint(img_loc, 3)
    img = np.array(img)
    img = cv2.resize(img, (512, 512))
    img = util.uint2single(img)
    sf = 4

    img_lq, _ = degradation_bsrgan(img, sf=sf, lq_patchsize=72)
...
if __name__ == '__main__':
    img = util.imread_uint('/home/ziga/ziga-work/degradations/4415.jpg', 3)
    #w, h, _ = img.shape
    #k_w = 512 // w
